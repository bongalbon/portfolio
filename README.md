...
* **Front-end :** HTML5 Sémantique, JavaScript Vanilla (ES6+)
* **Styling & UI :** Tailwind CSS (CDN), Effets Glassmorphism, Responsive Design
* **Icônes :** Lucide Icons (CDN)
* **Formulaire :** Intégration Formspree (Traitement sans serveur / AJAX)
